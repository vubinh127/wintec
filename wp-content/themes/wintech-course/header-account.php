                        ...
                        <div id="acc-dropdown-menu"
                            ...
                            <ul class="py-1">
                                <li><a href="#" class="flex items-center gap-3 px-4 py-2.5 text-gray-700 text-[13.5px] hover:bg-gray-50 transition-colors duration-150">
                                    <svg class="w-[18px] h-[18px] shrink-0 text-gray-500" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z"/><polyline stroke-linecap="round" stroke-linejoin="round" points="17 21 17 13 7 13 7 21"/><polyline stroke-linecap="round" stroke-linejoin="round" points="7 3 7 8 15 8"/></svg>
                                    Khóa Học Của Tôi</a></li>
                                <li><a href="#" class="flex items-center gap-3 px-4 py-2.5 text-gray-700 text-[13.5px] hover:bg-gray-50 transition-colors duration-150">
                                    <svg class="w-[18px] h-[18px] shrink-0 text-gray-500" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                                    Hồ sơ của tôi</a></li>
                                <li><a href="#" class="flex items-center gap-3 px-4 py-2.5 text-gray-700 text-[13.5px] hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <li><a href="#" class="flex items-center gap-3 px-4 py-2.5 text-gray-700 text-[13.5px] hover:bg-gray-50 transition-colors duration-150">
                                    <svg class="w-[18px] h-[18px] shrink-0 text-gray-500" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>
                                    Khóa học yêu thích</a></li>
                                <li><a href="#" class="flex items-center gap-3 px-4 py-2.5 text-gray-700 text-[13.5px] hover:bg-gray-50 transition-colors duration-150">
                                    <svg class="w-[18px] h-[18px] shrink-0 text-gray-500" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>
                                    Tin nhắn</a></li>
                                <li><a href="#" class="flex items-center gap-3 px-4 py-2.5 text-gray-700 text-[13.5px] hover:bg-gray-50 transition-colors duration-150">
                                    <svg class="w-[18px] h-[18px] shrink-0 text-gray-500" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><polyline stroke-linecap="round" stroke-linejoin="round" points="12 8 12 12 14 14"/><path stroke-linecap="round" stroke-linejoin="round" d="M3.05 11a9 9 0 108.94-8.95"/><polyline stroke-linecap="round" stroke-linejoin="round" points="1 4 3 11 10 9"/></svg>
                            ...
                            <div class="py-1">
                                <a href=""
                                    ...
                                    <svg class="w-[18px] h-[18px] shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4"/><polyline stroke-linecap="round" stroke-linejoin="round" points="16 17 21 12 16 7"/><line stroke-linecap="round" stroke-linejoin="round" x1="21" y1="12" x2="9" y2="12"/></svg>
                                    Đăng xuất
                                </a>
                            </div>
                        </div>
